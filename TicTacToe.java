...
public class TicTacToe {
    ...
    TicTacToe() {
        ...
        textLabel.setForeground(new Color(139, 69, 19) );
        ...
        //  restart.setPreferredSize(new Dimension(10,10));
        ...
        for(int r = 0 ; r < 3; r++) {
            for(int c = 0;c < 3; c++){
                ...
                tile.setBackground(new Color(179, 133, 212));
                tile.setForeground(Color.white);
                tile.setFont(new Font("Arial" , Font.BOLD , 120));
                tile.setFocusable(false);
                // tile.setBorder(new RoundedBorder(10));
